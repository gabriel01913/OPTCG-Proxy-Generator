...
function SettingsArea() {
  return (
    <div className="flex h-full w-full flex-col justify-between gap-4 bg-[#FFFAFA80] border-2 border-[#767676] md:w-[25%] rounded-lg shadow-lg shadow-[#000000a8] p-4">
      <div className="flex flex-col gap-y-2 md:flex-row">
        <div className={`${SETTINGS_COLUM}`}>
          <label className='text-[17px] -ml-[35px] font-bold'>PDF Margins (mm)</label>
